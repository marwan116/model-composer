...
.. |PyPI version shields.io| image:: https://img.shields.io/pypi/v/model-composer.svg
   :target: https://pypi.org/project/model-composer/
.. |PyPI license| image:: https://img.shields.io/pypi/l/model-composer.svg
   :target: https://pypi.python.org/pypi/
.. |PyPI pyversions| image:: https://img.shields.io/pypi/pyversions/model-composer.svg
   :target: https://pypi.python.org/pypi/model-composer/
.. |Downloads| image:: https://pepy.tech/badge/model-composer/month
   :target: https://pepy.tech/project/model-composer
.. |image1| image:: https://pepy.tech/badge/model-composer
   :target: https://pepy.tech/project/model-composer
